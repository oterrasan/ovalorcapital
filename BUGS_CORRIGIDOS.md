...
□ META_TITLE ≤55 chars está sendo extraído do prompt e salvo em metrics.meta_title?
□ api/article.js usa metrics.meta_title (não titulo) para o <title>?
□ core/image_processor.js salva como WebP quality 82 (não JPEG)?
□ robots.txt ainda tem Disallow: /admin/ e Disallow: /admin?
□ api/institutional.js tem as duas páginas (/quem-somos/ e /politica-editorial/)?
□ vercel.json tem as 4 rotas institucionais antes das rotas de categoria?
```
