...
const FEEDS_DIRETOS_GARANTIDOS = [
  ...
  { url: "https://g1.globo.com/rss/g1/",                                        name: "G1",                        cats: ["brasil-on","politica","economia"] },
  ...
  { url: "https://agenciabrasil.ebc.com.br/feed.xml",                          name: "Agência Brasil",            cats: ["brasil-on","politica","economia"] },
  { url: "https://noticias.r7.com/feed.xml",                                    name: "R7",                        cats: ["brasil-on"] },
  { url: "https://www.valor.com.br/rss",                                        name: "Valor Econômico",           cats: ["economia","negocios","financas","industria"] },
  { url: "https://exame.com/feed/",                                             name: "Exame",                     cats: ["negocios","economia","tecnologia"] },
  { url: "https://www.infomoney.com.br/feed/",                                  name: "InfoMoney",                 cats: ["financas","economia"] },
  { url: "https://epocanegocios.globo.com/rss/",                                name: "Época Negócios",            cats: ["negocios","economia"] },
  { url: "https://forbes.com.br/feed/",                                         name: "Forbes Brasil",             cats: ["negocios","brasil-on","financas"] },
  { url: "https://istoedinheiro.com.br/feed/",                                  name: "IstoÉ Dinheiro",            cats: ["economia","financas","negocios"] },
  { url: "https://braziljournal.com/feed/",                                     name: "Brazil Journal",            cats: ["negocios","economia","financas"] },
  { url: "https://neofeed.com.br/feed/",                                        name: "NeoFeed",                   cats: ["negocios","tecnologia","financas"] },
  { url: "https://www.moneytimes.com.br/feed/",                                 name: "Money Times",               cats: ["financas","economia","negocios"] },
  { url: "https://www.bloomberglinea.com/rss/",                                 name: "Bloomberg Línea",           cats: ["economia","negocios","financas","internacional"] },
  { url: "https://www.bbc.com/portuguese/index.xml",                            name: "BBC Brasil",                cats: ["internacional","brasil-on","tecnologia"] },
  { url: "https://www.poder360.com.br/feed/",                                   name: "Poder360",                  cats: ["politica","brasil-on"] },
  { url: "https://congressoemfoco.uol.com.br/feed/",                            name: "Congresso em Foco",         cats: ["politica","brasil-on","economia"] },
  { url: "https://www.jota.info/feed",                                          name: "JOTA",                      cats: ["economia","politica","negocios"] },
  { url: "https://www.conjur.com.br/rss.xml",                                   name: "Conjur",                    cats: ["economia","brasil-on"] },
  { url: "https://www.migalhas.com.br/rss.aspx",                               name: "Migalhas",                  cats: ["economia","brasil-on"] },
  ...
  { url: "https://vocesa.abril.com.br/feed/",                                   name: "Você S/A",                  cats: ["brasil-on","negocios"] },
  { url: "https://crescer.globo.com/rss.xml",                                   name: "Crescer",                   cats: ["familia"] },
  { url: "https://claudia.abril.com.br/feed/",                                  name: "Claudia",                   cats: ["familia"] },
  { url: "https://www.zapimoveis.com.br/blog/feed/",                            name: "ZAP Imóveis",               cats: ["brasil-on"] },
  { url: "https://www.automotivebusiness.com.br/feed/",                         name: "Automotive Business",       cats: ["industria","negocios"] },
  { url: "https://www.vaticannews.va/pt/rss.xml",                               name: "Vatican News Brasil",       cats: ["brasil-on"] },
  { url: "https://www.gazetadopovo.com.br/feed/",                               name: "Gazeta do Povo",            cats: ["brasil-on","politica"] },
  ...
  { url: "https://feeds.bloomberg.com/markets/news.rss",                        name: "Bloomberg",                 cats: ["economia","financas","internacional"] },
  { url: "https://www.ft.com/rss/home",                                         name: "Financial Times",           cats: ["economia","negocios","financas"] },
  ...
  { url: "https://www.theguardian.com/world/rss",                               name: "The Guardian",              cats: ["internacional","economia"] },
  { url: "https://feeds.bbci.co.uk/news/rss.xml",                              name: "BBC News",                  cats: ["internacional","tecnologia","economia"] },
  ...
  { url: "https://feeds.elpais.com/mrss-s/pages/ep/site/elpais.com/portada",   name: "El País",                   cats: ["internacional","politica"] },
