...
CATEGORIA: escolha exatamente uma: politica | economia | negocios | investimentos | seguros | mercados | educacao | industria | tecnologia | esportes | saude | familia | tributacao | regulacao | parcerias | internacional | vc | colunistas | variedades | investigativo | seguranca | cultura | profissoes | vagas
...
function parse(raw) {
  ...
  const catsValidas = ["politica","economia","negocios","investimentos","seguros","mercados","educacao","industria","tecnologia","esportes","saude","familia","tributacao","regulacao","parcerias","internacional","vc","colunistas","variedades","investigativo","seguranca","cultura","profissoes","vagas"];
