...
function injetarEstilosMiolo(){
  ...
  st.textContent = [
    ...
    '.ovc-pilula-item{padding:0 8px;border-right:1px solid #f0f2f5;min-width:0;overflow:hidden;}',
    ...
    '.ovc-pilula-texto{font-size:11px;color:#1a1a2e;line-height:1.45;font-weight:500;',
