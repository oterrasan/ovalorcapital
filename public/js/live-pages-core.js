    ...
    rail.innerHTML = `
      <section class="ovc-panel ovc-story-list">
        ...
        <div class="ovc-mini-list">
          <article class="ovc-mini-item"><div><h4><a href="/radar/">Radar OVC</a></h4><p>Indicadores, atalhos e atualizações do dia.</p></div><div></div></article>
          <article class="ovc-mini-item"><div><h4><a href="/dados/">Dados OVC</a></h4><p>Cotações, agenda econômica e painéis do portal.</p></div><div></div></article>
      ...
      <section class="ovc-panel ovc-story-list" style="margin-top:18px">
        <h3>Redação OVC</h3>
        <p style="font-size:13px;color:#64748b;line-height:1.6;margin:0 0 12px">Tem uma pauta, denúncia ou oportunidade institucional?</p>
        <a class="ovc-btn" href="/contato/" style="display:flex;justify-content:center">Enviar para a redação</a>
      </section>`;
  }
