(function(){
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    if (copy) {
      copy.innerHTML = '© 2026 <strong>O Valor Capital</strong> — Redação OVC. Todos os direitos reservados.'
        + '&nbsp;&nbsp;<span style="color:#aaa;font-size:.82em;">🔒 Conexão segura HTTPS</span>';
    }
