...
// Processa em lotes pequenos (padrão 4) para respeitar o limite de 10s do Vercel.
// Uso: GET /api/manage?action=audit_images
//      GET /api/manage?action=audit_images&offset=4  (próximo lote)
// Continua chamando até receber { done: true }
